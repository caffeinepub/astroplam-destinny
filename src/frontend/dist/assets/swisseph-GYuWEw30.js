...
var SwissEphModule = (() => {
  ...
  return async function(moduleArg = {}) {
    ...
    ((_b2 = (_a2 = globalThis.process) == null ? void 0 : _a2.versions) == null ? void 0 : _b2.node) && ((_c = globalThis.process) == null ? void 0 : _c.type) != "renderer";
    ...
    var FS_stdin_getChar = () => {
      ...
      if (!FS_stdin_getChar_buffer.length) {
        var result = null;
        if ((_a3 = globalThis.window) == null ? void 0 : _a3.prompt) {
    ...
    var TTY = { ttys: [], init() {
      ...
      var _a3;
      if (((_a3 = tty.output) == null ? void 0 : _a3.length) > 0) {
        out(UTF8ArrayToString(tty.output));
        tty.output = [];
      }
    }, ioctl_tcgets(tty) {
    ...
    var FS = { root: null, mounts: [], devices: {}, streams: [], nextInode: 1, nameTable: null, currentPath: "/", initialized: false, ignorePermissions: true, filesystems: null, syncFSRequests: 0, readFiles: {}, ErrnoError: class {
      ...
      (_a3 = FS.createDevice).major ?? (_a3.major = 64);
    ...
    var getEnvStrings = () => {
      ...
      if (!getEnvStrings.strings) {
        var lang = (((_a3 = globalThis.navigator) == null ? void 0 : _a3.language) ?? "C").replace("-", "_") + ".UTF-8";
    ...
    var _malloc, __emscripten_stack_restore, __emscripten_stack_alloc, _emscripten_stack_get_current, wasmMemory;
    function assignWasmExports(wasmExports2) {
      Module["_free"] = wasmExports2["m"];
      _malloc = Module["_malloc"] = wasmExports2["n"];
      Module["_swe_set_ephe_path_wrap"] = wasmExports2["o"];
      Module["_swe_julday_wrap"] = wasmExports2["p"];
      Module["_swe_revjul_wrap"] = wasmExports2["q"];
      Module["_swe_calc_ut_wrap"] = wasmExports2["r"];
      Module["_swe_get_planet_name_wrap"] = wasmExports2["s"];
      Module["_swe_lun_eclipse_when_wrap"] = wasmExports2["t"];
      Module["_swe_sol_eclipse_when_glob_wrap"] = wasmExports2["u"];
      Module["_swe_houses_wrap"] = wasmExports2["v"];
      Module["_swe_close_wrap"] = wasmExports2["w"];
      Module["_swe_version_wrap"] = wasmExports2["x"];
      __emscripten_stack_restore = wasmExports2["y"];
      __emscripten_stack_alloc = wasmExports2["z"];
      _emscripten_stack_get_current = wasmExports2["A"];
      wasmMemory = wasmExports2["k"];
